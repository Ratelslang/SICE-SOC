...
def create_monthly_report(filename, month, year, data=None):
    ...
    if data is None:
        data = {
            ...
            'total_incidents': 0,              # How many incidents this month?
            'security_alerts': 5,              # How many security alerts?
            'gate_checks': 156,                # How many gate access checks?
            'cctv_issues': 0,                 # How many CCTV problems?
            'alarm_tests': 4,                 # How many times tested alarm?
            'patrol_hours': 480,              # Total patrol hours
            'personnel_trained': 8,           # How many staff trained?
